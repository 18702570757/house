...
<DL class="search clearfix">
  ...
  <UL>
    ...
    <LI>标题：<INPUT class=text type=text name=name value="${vo2.name}"> <LABEL class=ui-blue><INPUT value=搜索房屋 type=submit name=search></LABEL>
    </LI></UL></DT>
  <DD>
  <UL>
  ...
  <UL>
    ...
    <LI><SELECT name=floorage> <OPTION ${vo2.floorage==""?"selected":""} value="">不限</OPTION> <OPTION
      value=0-40 ${vo2.floorage=="0-40"?"selected":""}>40以下</OPTION> <OPTION value=40-500 ${vo2.floorage=="40-500"?"selected":""}>40-500</OPTION> <OPTION
      value=500-1000000 ${vo2.floorage=="500-1000000"?"selected":""}>500以上</OPTION></SELECT> </LI></UL></DD></FORM></DL></DIV>
<DIV class="main wrap">
<TABLE class=house-list>
  ...
  <TR>
    ...
    <TD class=house-price><SPAN>111.0</SPAN>元/月</TD></TR>
