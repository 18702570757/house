...
<DIV class=search>
<FORM method= ><INPUT class=text type=text name=keywords>
 <LABEL class="ui-green searchs"><a href="/house/details?name=${house.HName}" target="_blank">搜索房屋</a></LABEL>
</FORM></DIV></DIV>
...
<DL class="search clearfix">
  ...
  <UL>
    ...
    <LI>标题：<INPUT class=text type=text name=title> <LABEL class=ui-blue><INPUT onclick=doSearch(${house.HName}) value=搜索房屋 type=button name=search></LABEL>
    </LI></UL></DT>
  <DD>
  <UL>
  ...
  <UL>
    ...
    <LI><SELECT id=floorage name=floorage> <OPTION <%--${house.HRect==""?"selected":""}--%>
      value="">不限</OPTION> <OPTION value=0-40 <%--${house.HRect=="0-40"?"selected":""}--%>>40以下</OPTION> <OPTION
      value=40-500 <%--${house.HRect=="40-50"?"selected":""}--%>>40-500</OPTION> <OPTION
    value=500-1000000 <%--${house.HRect=="0-40"?"selected":"500-1000000"}--%>>500以上</OPTION></SELECT> </LI></UL></DD></FORM></DL></DIV>
...
<P>面　　积：<SPAN>${house.HRect}m<SUP>2</SUP></SPAN></P>
...
<script>
  function dosearch(hName) {
    location.href="/house/search?hName="+hName;
